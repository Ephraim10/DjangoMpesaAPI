...
urlpatterns = [
    ...
    path('add_products/', general_views.add_products, name='add_products'),
    path('products/', general_views.view_products, name='products'),
    path('delete-products/<id>', general_views.delete_product, name='delete-products'),
    path('update-products/<id>', general_views.update_product, name='update-products'),
